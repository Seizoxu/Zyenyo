...
public class BotConfig
{
	...
	public static final String SCRAPE_DATA_FILEPATH = "ZBotData/user/ScrapeData/";
	public static final String INDEX_COUNTS_FILEPATH = "ZBotData/user/ScrapeData/COUNTS.zbif"; //ZBIF = ZyenyoBotIndexFile.
	public static final String INDEX_IDS_FILEPATH = "ZBotData/user/ScrapeData/IDs.zbif";
	public static final List<Long> ADMINISTRATOR_IDS = List.of(642193466876493829l, 365691073156087819l);
	
	protected static final File PROMPT_RATING_FILE = new File("ZBotData/assets/TypingPrompts/PromptRatingMap.zbo");
	protected static final File PROMPT_DIFFICULTY_FILE = new File("ZBotData/assets/TypingPrompts/SortedPromptsList.zbo");
